...
# Generated: Tue Mar 31 13:51:10 2015
##################################################
...
class spectral(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, final_freq=110, gain=0, audio_output=""):
        ...
        self.settings = Qt.QSettings("GNU Radio", "spectral")
...
if __name__ == '__main__':
    ...
    tb = spectral(final_freq=options.final_freq, gain=options.gain, audio_output=options.audio_output)
    tb.start()
    tb.show()
    def quitting():
        tb.stop()
